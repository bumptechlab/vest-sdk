...
import book.res.strings.Strings
import book.util.AppGlobal
import book.util.LogUtil
import book.res.strings.`Strings-EN`
import book.res.strings.`Strings-HI`
import book.res.strings.`Strings-IN`
import book.res.strings.`Strings-PT`
