...
public final class PayloadReader {
    ...
    public static String getString(final File apkFile, final int id) {
        ...
        try {
            return new String(bytes, ApkPackageUtil.DEFAULT_CHARSET);
    ...
    private static Map<Integer, ByteBuffer> getAll(final File apkFile) {
        ...
        try {
            ...
            try {
                ...
                final ByteBuffer apkSigningBlock2 = ApkPackageUtil.findApkSigningBlock(fileChannel).getFirst();
                idValues = ApkPackageUtil.findIdValues(apkSigningBlock2);
