...
import poetry.sdk.core.manager.ActivityManager
import poetry.sdk.core.manager.AdjustManager
import poetry.sdk.core.manager.ConfigurationManager
...
object VestCore {
    ...
    private val WEBVIEW_ACTIVITY_CLASS_NAME = "poetry.sdk.ui.WebActivity"
